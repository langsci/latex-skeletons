...
\setmainfont[
  ...
  \newcommand{\lsBackTitleFont}{\sffamily\addfontfeatures{Scale=MatchUppercase}\fontsize{24pt}{10mm}\selectfont}
...
\pgfsetlayers{lspcls_bg,main}
	...
	\begin{tikzpicture}[remember picture, overlay,bg/.style={outer sep=0}]
		...
		% Text and Graphics Layer
			...
			% Book Back Cover
			\node [below right = 16.5mm and 7.5mm of lspcls_bg2.north west, text width=11.5cm] (lspcls_backtitle) {\color{\lsCoverFontColour}\lsBackTitleFont{\nohyphens{\BackTitle}\par}};
