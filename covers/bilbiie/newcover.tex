...
%\StrLen{\subtitle}[\subtitleStrLen] % see below for comment on \'e and \c in StrLen
...
\pgfsetlayers{lspcls_bg,main}
	...
	\begin{tikzpicture}[remember picture, overlay,bg/.style={outer sep=0}]
		...
		% Text and Graphics Layer
			...
			%\ifnum\subtitleStrLen=0  % Is there a subtitle?    % StrLen seems to be incompatible with strings that contain \'e or \c 
