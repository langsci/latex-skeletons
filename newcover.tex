...
\pgfsetlayers{lspcls_bg,main}
	...
	\begin{tikzpicture}[remember picture, overlay,bg/.style={outer sep=0}]
		...
		% Text and Graphics Layer
			...
			\node [below right = 57.5mm and 4mm of lspcls_bgspline.north, rotate=270, baseline=20pt] (lspcls_splineauthor) {\color{\lsSeriesColor} \lsSpineAuthorFont{\author}}; % This is messy.
			\node [below right = 13mm and 0mm of lspcls_splineauthor.north east, rotate=270] () {\color{\lsSeriesColor} \lsSpineTitleFont{\title}}; 
			...
			\node [below right = 10mm and 7.5mm of lspcls_bg1.north west, text width=13.5cm] (lspcls_covertitle) {\color{\lsCoverFontColour}\lsCoverTitleFont{\title}}; % x = 15mm - 7.5mm ; y = 17.5mm - 7.5mm
			
			\ifx\@subtitle\empty  % Is there a subtitle?
				\node [below = 11.2mm of lspcls_covertitle.south, text width=140mm] {\color{\lsCoverFontColour}\lsCoverAuthorFont{\author}}; % If not, print the author
				\else
				\node [below = 8mm of lspcls_covertitle.south, text width=140mm] (lspcls_coversubtitle) {\color{\lsSeriesColor} \lsCoverSubTitleFont -\subtitle-}; 
			...
			\node [below = 10mm of lspcls_backtitle, text width=11.5cm, align=justify] {\color{\lsCoverFontColour}\lsBackBodyFont{\BackBody}};
