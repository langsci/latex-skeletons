...
\pgfsetlayers{lspcls_bg,main}
	...
	\begin{tikzpicture}[remember picture, overlay,
		...
		\begin{pgfonlayer}{lspcls_bg} % background layer
			\node [bg, left = 7.75mm of current page.east, fill=\lsSeriesColor, minimum height=22.5cm, minimum width=15.5cm] (lspcls_bg1) {}; % Die können wir noch dynamisch bestimmen
		...
		% Text and Graphics Layer
			...
			% Book Cover
			\node [above left = 8.5mm and 8.5mm of lspcls_bg1.south east] {\color{white}\includegraphics{./LSP/lsp-logos/langsci_logo_nocolor.pdf}};
			\node [below right = 15pt and 17.5pt of lspcls_bg1.north west, text width=13.5cm] (lspcls_covertitle) {\color{white}\lsCoverTitleFont{\title}};
			\node [below = 19.2mm of lspcls_covertitle.south, text width=13.5cm] {\color{white}\lsCoverAuthorFont{\author}};	% We need to include the possibilty to insert subtitles here
			\node [above right= 16mm and -1mm of lspcls_bg1.south west, rectangle, fill=white, minimum size=17pt] (lspcls_square) {};
			\node [right = 7mm of lspcls_square.center] {\color{white}\lsCoverSeriesFont{\lsSeriesTitle}};
			
			% Book Back Cover
			\node [below right = 15pt and 17.5pt of lspcls_bg2.north west, text width=13.5cm] (lspcls_backtitle) {\color{white}\lsBackTitleFont{\BackTitle}};
			\node [below=19.2mm of lspcls_backtitle, text width=13.5cm, align=justify] {\color{white}\lsBackBodyFont{\BackBody}};
			\node [above left = 15mm and 7mm of lspcls_bg2.south east] {\color{white}ISBN \lsBackBodyFont{\lsISBN}};
